...
fname = '/Users/rmillin/Documents/Insight/diverse-reading/data/diverse_0_01_25.json'
...
for num in range(1,13):
    try:
        file_name = '/Users/rmillin/Documents/Insight/diverse-reading/data/diverse_' +str(num) + '_01_25.json'
