...
print(desc_input)
end_time = time.time()
print("Time to get book description was %g seconds" % (end_time - start_time))
...
end_time = time.time()
print("Time to load tfidf was %g seconds" % (end_time - start_time))
...
end_time = time.time()
print("Time to load cleaned descriptions was %g seconds" % (end_time - start_time))
...
end_time = time.time()
print("Time to return results was %g seconds" % (end_time - start_time))
